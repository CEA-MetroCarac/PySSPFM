...
def construct_hyst_comp(mean_hyst, mean_loop, hyst, loop, bckgnd=None,
...
def generate_pars(file_path_in=None):
    """
...
def main_plot_pix_extrem(user_pars, dir_path_in, verbose=False,
    ...
    meas_pars, sign_pars, treat_pars = generate_pars(
