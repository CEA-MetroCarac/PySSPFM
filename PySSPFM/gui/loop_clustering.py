"""
--> Executable Script
Graphical interface for loop clustering
 (run loop_clustering.main_loop_clustering)
"""
    ...
    def generate_default_output_dir(input_dir):
        if input_dir != "":
            output_dir = save_path_management(
                ...
                dirname="loop_clustering", lvl=1, create_path=False,
                post_analysis=True)
        else:
            output_dir = ""
        return output_dir
