...
def main(parent=None):
    ...
    app = init_secondary_wdw(
        parent=parent, wdw_title="SSPFM Data Analysis: Step 2 = hyst to map")
    ...
    browse_button_in = ttk.Button(app, text="Browse", command=browse_directory)
    ...
    # Fit function
    label_func = ttk.Label(app, text="Function:")
    row = grid_item(label_func, row, column=0, sticky="e", increment=False)
    func_var = ttk.Combobox(app, values=["sigmoid", "arctan"])
    ...
    method_var = ttk.Combobox(app, values=["leastsq", "least_square", "nelder"])
    ...
    # Asymmetric fit
    label_asym = ttk.Label(app, text="Asymmetric:")
    ...
    chck_asym = ttk.Checkbutton(app, variable=asymmetric_var)
    ...
    label_thresh_inf = ttk.Label(app, text="Inflection threshold [%]:")
    row = grid_item(label_thresh_inf, row, column=0, sticky="e",
                    increment=False)
    inf_thresh_var = tk.IntVar(value=user_parameters['inf thresh'])
    scale_thresh_inf = ttk.Scale(app, from_=1, to=100, variable=inf_thresh_var,
    ...
    label_value_inf = ttk.Label(app, text=str(inf_thresh_var.get()))
    ...
    label_thresh_sat = ttk.Label(app, text="Saturation threshold [%]:")
    row = grid_item(label_thresh_sat, row, column=0, sticky="e",
                    increment=False)
    sat_thresh_var = tk.IntVar(value=user_parameters['sat thresh'])
    scale_thresh_sat = ttk.Scale(app, from_=1, to=100, variable=sat_thresh_var,
                                 orient="horizontal", length=100,
    ...
    label_value_sat = ttk.Label(app, text=str(sat_thresh_var.get()))
    ...
    phase_mode_var = ttk.Combobox(app,
    ...
    # Phase Forward Value
    label_fwd = ttk.Label(app, text="Phase Forward Value:")
    ...
    entry_fwd = ttk.Entry(app, textvariable=pha_fwd_var)
    ...
    # Phase Reverse Value
    label_rev = ttk.Label(app, text="Phase Reverse Value:")
    ...
    entry_rev = ttk.Entry(app, textvariable=pha_rev_var)
    ...
    label_func_pha = ttk.Label(app, text="Function for Piezoresponse:")
    row = grid_item(label_func_pha, row, column=0, sticky="e", increment=False)
    func_pha_var = ttk.Combobox(app, values=["cosine", "sine"])
    ...
    # Differential mode
    label_man = ttk.Label(app, text="Mode:")
    row = grid_item(label_man, row, column=0, sticky="e", increment=False)
    diff_mode_var = ttk.Combobox(app, values=["set", "auto"])
    ...
    label_min = ttk.Label(app, text="Min limit (*):")
    ...
    entry_min = ttk.Entry(app, textvariable=diff_domain_min_var)
    ...
    label_max = ttk.Label(app, text="Max limit (*):")
    ...
    entry_max = ttk.Entry(app, textvariable=diff_domain_max_var)
    ...
    # Saturation mode
    label_sat_mode = ttk.Label(app, text="Mode:")
    row = grid_item(label_sat_mode, row, column=0, sticky="e", increment=False)
    sat_mode_var = ttk.Combobox(app, values=["set", "auto"])
    ...
    label_sat_min = ttk.Label(app, text="Min limit (*):")
    ...
    entry_sat_min = ttk.Entry(app, textvariable=sat_domain_min_var)
    ...
    label_sat_max = ttk.Label(app, text="Max limit (*):")
    ...
    entry_sat_max = ttk.Entry(app, textvariable=sat_domain_max_var)
