...
def test_mean_loop_1_off():
    ...
    assert np.sum(mean_best_loop.piezorep) == approx(0.010593325340580346, abs=1e-8)
    ...
    assert np.sum(best_hysts.params) == approx(0.9034962392174538, abs=1e-8)
...
def test_mean_loop_1_coupled():
    ...
    assert fit_res[3] == approx(0.999334257370327, abs=1e-8)
...
def test_mean_loop_2_off():
    ...
    assert np.sum(mean_best_loop.amp) == approx(0.02825795313366302, abs=1e-8)
...
def test_mean_loop_2_coupled():
    ...
    assert fit_res[3] == approx(0.9988143410969148, abs=1e-8)
