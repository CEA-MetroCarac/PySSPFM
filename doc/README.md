...
2. Data crafted by dedicated scripts for this purpose:
    ...
    - <code><a href="https://github.com/CEA-MetroCarac/PySSPFM/blob/main/PySSPFM/utils/nanoloop_to_hyst/gen_data.py">utils/nanoloop_to_hyst/gen_data.py</a></code> is responsible for generating a txt_loops file. The ensuing examples are rooted in this source:
