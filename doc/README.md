...
&#8226 extract settings from json files, with get_settings_dict, based on function <code>load_parameters_from_file</code> of the <code><a href="https://github.com/CEA-MetroCarac/PySSPFM/blob/main/PySSPFM/utils/core/extract_params_from_file.py">utils/core/extract_params_from_file.py</a></code> script (refer to <a href="https://github.com/CEA-MetroCarac/PySSPFM/tree/main/doc#x-core-scripts">X) Core scripts</a> in the documentation)<br>
&#8226 adapt the settings associated with path management, in order to convert it in a real path that can be used in the python code <br>
