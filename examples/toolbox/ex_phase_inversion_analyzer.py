"""
Example of phase_inversion_analyzer methods
"""
...
from PySSPFM.toolbox.phase_inversion_analyzer import \
    main_phase_inversion_analyzer


def example_phase_inversion_analyzer(make_plots=False, verbose=False):
    """
    Example of main_phase_inversion_analyzer functions.
    ...
    figures: list of plt.figure
        ...
        If make_plots is False, returns phase inversion table.
    """
    # Path management
    ...
    # ex main_phase_inversion_analyzer
    phase_grad_tab, map_dim, figures = \
        main_phase_inversion_analyzer(user_pars, dir_path_in, range_file=None,
    ...
    if make_plots:
        ...
        return phase_grad_tab, map_dim


if __name__ == '__main__':
    # saving path management
    dir_path_out, save_plots = save_path_example(
        "phase_inversion_analyzer.py", save_example_exe=True,
        save_test_exe=False)
    figs = []
    figs += example_phase_inversion_analyzer(make_plots=True, verbose=True)
