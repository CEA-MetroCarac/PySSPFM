...
def example_mean_loop(phase='1', mode='off', verbose=False, make_plots=False):
    """
    Example of mean_loop functions.
...
if __name__ == '__main__':
    ...
    dir_path_out, save_plots = save_path_example(
        "mean_loop", save_example_exe=True, save_test_exe=False)
    figs = []
    figs += example_mean_loop(phase='1', mode='on', verbose=True,
                              make_plots=True)
    figs += example_mean_loop(phase='1', mode='off', verbose=True,
                              make_plots=True)
    figs += example_mean_loop(phase='1', mode='coupled', verbose=True,
                              make_plots=True)
    figs += example_mean_loop(phase='2', mode='on', verbose=True,
                              make_plots=True)
    figs += example_mean_loop(phase='2', mode='off', verbose=True,
                              make_plots=True)
    figs += example_mean_loop(phase='2', mode='coupled', verbose=True,
                              make_plots=True)
